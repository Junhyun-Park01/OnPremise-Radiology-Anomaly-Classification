...
dataset = load_dataset("json", data_files="./dataset/binary_label_paragraph_train.json")
print(dataset)
# print(dataset['train']['Result'])
# file = open("./dataset/binary_label_paragraph_train.json")
...
model.save_pretrained("./trained_model/contrastive_encoder_document")
