...
if __name__ == "__main__":
                ...
                for i in range(len(Emr_split_data)):
                    ...
                    while success_flag == 0 and error_count <= 50:
                        try:
                            ...
                            time.sleep(10)
                            print("error occured in chatgpt server-train")
                            error_count += 1
                            continue
                    ...
                    #### If error exceed 100 time than skip the paragraph
                    if error_count > 50:
                        trouble_file.append(file)
                        break
    ...
    np.save('remain_folders.npy', remain_folders)
    np.save('trouble_para_train.npy', trouble_file)
