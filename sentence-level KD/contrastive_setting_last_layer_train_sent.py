...
## load AutoTokenizer from RadBERT
...
def train(epoch, radbert_encoder, classifier, dataloader, optimizer, device, batch_size, loss_func):
    ...
    for e in range(1, epoch + 1):
        ...
        for data in progress_bar:
            ...
            ##### we use pooler output for the classifier
...
model = MLP(target_size= 3, input_size= 768)
...
torch.save(model.state_dict(), "./trained_model/mlp_classifier_radbert_sent")
